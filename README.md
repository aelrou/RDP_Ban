...
This script will determin if a remote IP address has failed more than 10 RDP logins within 10 minutes. If it has, that IP address is added to a firewall block rule on port 3389 TCP/UDP.
